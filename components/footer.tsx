      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="text-2xl font-bold text-gradient font-playfair mb-4">DigitalBoost</div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-muted-foreground">Brand Design</span>
              </li>
              <li>
                <span className="text-muted-foreground">Digital Ads</span>
              </li>
              <li>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-muted-foreground">
            © 2025 Dreams. All rights reserved. Built with passion for digital excellence.
          </p>
        </div>
      </div>
    </footer>
